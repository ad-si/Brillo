...
module Brillo.Internals.Interface.Simulate.Idle
        ( callback_simulate_idle )
where
import Brillo.Data.ViewPort
import Brillo.Internals.Interface.Callback
import qualified Brillo.Internals.Interface.Backend             as Backend
import qualified Brillo.Internals.Interface.Animate.State       as AN
import qualified Brillo.Internals.Interface.Simulate.State      as SM
import Data.IORef
